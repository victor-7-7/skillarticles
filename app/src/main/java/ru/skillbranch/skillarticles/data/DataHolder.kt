...
object LocalDataHolder {
    ...
    //    val localArticleItems: MutableList<ArticleItemData> =
//        generateArticleItems(200) as MutableList<ArticleItemData>
...
val longText2: String = """
We created an abstract 
class `SearchBgRenderer` that 
knows how to compute the top and the bottom offset of the line, but exposes an abstract `draw` function:
```abstract fun draw(canvas: Canvas, layout: Layout, 
startLine: Int,endLine: Int,startOffset: Int,endOffset: Int)```
The `draw` function will have different implementations
""".trimIndent()
